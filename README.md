...
1. `100%`开源
2. `100%`遵循Docker标准
3. 支持**多版本PHP**共存，可任意切换（PHP5.4、PHP5.6、PHP7.1、PHP7.2、PHP7.3、PHP7.4、PHP8.0、PHP8.1)
4. 支持绑定**任意多个域名**
5. 支持**HTTPS和HTTP/2**
...
9. 可一键选配常用服务：
    - 多PHP版本：PHP5.4、PHP5.6、PHP7.0-7.4、PHP8.0、PHP8.1
    - Web服务：Nginx、Openresty
    - 数据库：MySQL5、MySQL8主从、Redis、memcached、MongoDB、ElasticSearch
    - 消息队列：RabbitMQ
